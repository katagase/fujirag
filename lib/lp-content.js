...
export const releaseAnnouncement = {
  label: "プレスリリース",
  dateText: "2026年4月9日",
  title: "FUJI RAG を正式リリースしました",
  description:
    "オンプレミスで動くナレッジAI「FUJI RAG」を本日リリースしました。社内文書の検索・要約・FAQ自動応答を、データを外に出さずに実現します。詳細はプレスリリースをご覧ください。",
  ctaLabel: "プレスリリースを読む",
  ctaHref: "https://prtimes.jp/main/html/rd/p/000000002.000180307.html"
};
...
export const flowSteps = [
  {
    title: "STEP 1 無料デモ・PoC相談（最短2週間）",
    detail:
      "現状ヒアリングとデモを実施。NDA締結などの手続きを含め、最短2週間でPoC開始判断まで進められます。"
  },
  {
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "PoC開始までは最短2週間、PoC実施は1〜2ヶ月、本番導入まで含めると3〜6ヶ月が目安です。"
  },
  {
    question: "対応ファイル形式は？",
